...
API_ID = int(environ.get('API_ID', "21655839"))
API_HASH = environ.get('API_HASH', "11e4ed5bca3d4fee1c00f298db8c6b59")
...
PICS = (environ.get('PICS', 'https://tse1.mm.bing.net/th/id/OIP.MhjCrV-XlXEfv-0KaLKBAgAAAA?rs=1&pid=ImgDetMain&o=7&rm=3')).split()
...
premium = environ.get('PREMIUM_LOGS', '-1002975734886')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6732714410').split()]
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "alanshal") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1003012887561').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://nickelodeonsonicindiayt_db_user:NickelodeonSonicIndia96@alanshal.ltrca.mongodb.net/?retryWrites=true&w=majority&appName=alanshal")
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MotuPatluRaceToDiamondValleychat')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoviesIndia2025')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', -1003042011342))
GROUP_VERIFY_LOGS = int(environ.get('GROUP_VERIFY_LOGS', -1003037650612)) # Group verify stats 
REQ_CHANNEL = int(environ.get('REQ_CHANNEL', -1001998895377)) # movies request channel, else log channel
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+6J3H-BqwRG02ZTE1')
...
# Streaming
BIN_CHANNEL = int(environ.get("BIN_CHANNEL", "-1003016396355")) 
